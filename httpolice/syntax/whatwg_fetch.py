...
from httpolice.parse import auto, fill_names, literal, maybe_str, pivot
...
origin_or_null = origin | literal('null', case_sensitive=True)          > pivot
...
Access_Control_Allow_Credentials = literal('true', case_sensitive=True) > pivot
...
Cross_Origin_Resource_Policy = (
    literal('same-origin', case_sensitive=True) |
    literal('same-site', case_sensitive=True))                          > pivot
